...
### 2.4. Cible tertiaire — Étudiant·e international·e / Erasmus (perturabation J4)

| Champ | Détail |
|---|---|
| **Profil** | 15-25 ans · lycéen·ne ou étudiant·e hors France · cours dans sa langue maternelle · parfois en situation de handicap
| **Volume FR** | ~100 000 étudiants Erasmus en France/an + millions de lycéens européens post-contrat État
| **Pain point** | Interface et quiz en français uniquement — outil inutilisable pour un non-francophone · 70% des outils edtech non navigables au clavier
| **Critère clé** | Interface dans sa langue + quiz généré dans la langue du cours uploadé + conformité WCAG 2.1 AA (équivalent RGAA)
| **Persona de référence** | Lucia Martínez, 17 ans, lycéenne Séville, malvoyante, lecteur d'écran NVDA
---
...
### 3.4. Besoins de la cible tertiaire (Étudiant international — NEW post-J4)

- Naviguer intégralement au clavier et lecteur d'écran sans souris (Lucia : NVDA + Firefox)
- Générer un quiz de révision dans sa langue maternelle (espagnol, anglais, allemand…) à partir de ses cours
- Accéder à une interface avec contrastes suffisants (≥ 4.5:1) et balises alt sur toutes les images
- Utiliser un outil conforme WCAG 2.1 AA (équivalent européen du RGAA français)
- Bénéficier de la protection RGPD même en tant qu'utilisatrice hors France (données en UE)
...
- **Gestion des cours déposés** → visualisation et gestion des QCM par l'enseignant, valeur pour Mme Lefèvre
...
| Le document a été relu et validé par l'équipe complète | ✅ Oui | Validé équipe 21 — v3 post-perturbation J4 |
