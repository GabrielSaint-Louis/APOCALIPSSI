...
### 4.1. MVP must-have (Release 1) — à livrer mercredi 01/07 à 17h45
...
### 4.2. Pistes Release 2 (à livrer jeudi 02/07 à 17h45)
...
> Convention de versionnement : v1.0 initiale → v1.1/v1.2 révisions mineures → v2.0 post-perturbation. Chaque version committée séparément sur GitHub avec message explicite.
