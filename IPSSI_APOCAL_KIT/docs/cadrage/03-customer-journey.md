...
## 4. Parcours International & Accessibilité — Lucia Martínez (cible primaire C)

> **Rappel persona** : Lucia Martínez, 17 ans, lycéenne Terminale ES à Séville (Espagne). Malvoyante (acuité visuelle 10%), utilise NVDA (lecteur d’écran) et ZoomText (loupe logicielle). Navigue intégralement au clavier, sans souris. Ses cours sont en espagnol et elle prépare la Selectividad.

**Objectif du parcours** : Décrire comment Lucia découvre, utilise et adopte EduTutor IA malgré ses contraintes d’accessibilité et de langue. Repérer le moment exact où elle décroche.

**Format** : 5 étapes — Découverte → Inscription → 1ʳᵉ utilisation → Usage régulier → Recommandation.

### 4.1. Tableau de parcours

| Étape                  | Actions                                                                                                                                                   | Pensées (au « je »)                                                                                    | Émotion         | Frictions / Opportunités                                                                                                                                                                                               |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1. Découverte**      | Lucia découvre EduTutor IA via un forum d’étudiants malvoyants. Elle ouvre la page d’accueil avec Firefox et NVDA, puis tente de la parcourir au clavier. | _« Si je ne peux pas naviguer facilement au clavier, je perds tout de suite confiance. »_              | 😟 Méfiante     | **Friction** : page d’accueil non optimisée pour le lecteur d’écran, CTA mal décrits. **Opportunité** : navigation clavier complète + textes alternatifs sur tous les éléments interactifs.                            |
| **2. Inscription**     | Elle tente de créer un compte, change la langue en espagnol, remplit le formulaire et valide son email.                                                   | _« Je dois pouvoir m’inscrire sans dépendre de la souris ni deviner les erreurs du formulaire. »_      | 😟 Frustrée     | **Friction** : sélecteur de langue pas assez accessible, messages d’erreur non lus correctement. **Opportunité** : formulaire compatible NVDA, erreurs annoncées clairement, langue espagnole disponible dès l’entrée. |
| **3. 1ʳᵉ utilisation** | Lucia uploade un PDF de cours en espagnol, lance la génération d’un quiz et parcourt les questions au clavier.                                            | _« Si le quiz sort en français ou que les options ne sont pas lisibles, je ne peux pas m’en servir. »_ | 😟 Bloquée      | **Friction** : langue de sortie incohérente, composants non accessibles. **Opportunité** : détection automatique de la langue du document, quiz généré en espagnol, structure lisible par NVDA.                        |
| **4. Usage régulier**  | Elle génère plusieurs quiz par semaine, consulte son historique et suit ses scores avant ses examens.                                                     | _« Là, je peux vraiment réviser plus efficacement si tout reste lisible et stable. »_                  | 😊 Satisfaite   | **Friction** : tableaux de résultats peu accessibles, contraste insuffisant. **Opportunité** : tableaux bien structurés, contraste élevé, historique consultable au clavier.                                           |
| **5. Recommandation**  | Lucia recommande l’outil à d’autres élèves malvoyants et sur des groupes d’entraide en ligne.                                                             | _« Si l’outil reste accessible après les mises à jour, je peux le recommander sans hésiter. »_         | 😊 Ambassadrice | **Friction** : risque de régression accessibilité après mise à jour. **Opportunité** : engagement public RGAA/WCAG, tests d’accessibilité systématiques.                                                               |

### 4.2. Moment de décrochage potentiel

> **Étape 2 — Inscription** : si Lucia ne peut pas naviguer au clavier ou si les erreurs du formulaire ne sont pas annoncées par NVDA, elle abandonne immédiatement.
> **Étape 3 — 1ʳᵉ utilisation** : si le quiz ne respecte pas la langue du document source ou n’est pas lisible par le lecteur d’écran, elle ne revient pas.

**Investissements produit prioritaires** :

- Sélecteur de langue accessible au clavier.
- Messages d’erreur annoncés par lecteur d’écran.
- Détection automatique de la langue du document.
- Structure HTML compatible NVDA.
- Contraste élevé et navigation 100 % clavier.

### 4.3. Exigences RGAA / WCAG 2.1 AA

| Exigence                            | Priorité |
| ----------------------------------- | -------- |
| Navigation clavier complète         | 🔴 P0    |
| Textes alternatifs sur les images   | 🔴 P0    |
| Messages d’erreur annoncés          | 🔴 P0    |
| Contraste suffisant                 | 🔴 P0    |
| Compatibilité lecteur d’écran       | 🔴 P0    |
| Langue espagnole disponible         | 🔴 P0    |
| Structure sémantique correcte       | 🟠 P1    |
| Absence de régression accessibilité | 🟠 P1    |

### 4.4. Moment clé de levier

Le point de levier principal est l’entrée dans le produit : si l’inscription et la première génération sont accessibles, Lucia peut adopter durablement l’outil. L’amélioration doit donc viser en priorité l’expérience d’onboarding et la compatibilité lecteur d’écran.

---

## 5. Synthèse émotionnelle des 4 parcours

> **Objectif** : Visualiser d'un coup d'œil où les 4 personas vivent leurs pics et creux émotionnels. Permet de prioriser les investissements produit par effet de levier.

| Étape                                  | Camille (étudiante)         | Mme Lefèvre (enseignante)           | M. David Chen (établissement) | Lucia Martínez (accessibilité & i18n) |
| -------------------------------------- | --------------------------- | ----------------------------------- | ----------------------------- | ------------------------------------- |
| **1. Découverte / Besoin**             | 😐 Curieuse, sceptique      | 😐 Curieuse, prudente               | 😟 Prudent, sous pression     | 😟 Méfiante, expérimentée             |
| **2. Inscription / Évaluation**        | 😐 Vigilante                | 😟 **Impatiente (décrochage fort)** | 😐 Méticuleux, analytique     | 😟 Frustrée, persévérante             |
| **3. 1ʳᵉ utilisation / Décision**      | 😟 → 😊 Anxieuse → Soulagée | 😐 → 😊 Vigilante → Étonnée         | 😐 Engagé, un peu anxieux     | 😟 Bloquée, découragée                |
| **4. Usage régulier / Onboarding**     | 😊 Confiante, satisfaite    | 😊 Satisfaite, productive           | 😐 → 😊 Espérant → Soulagé    | 😐 Fonctionnel → 😊 Satisfaite        |
| **5. Recommandation / Renouvellement** | 😊 Enthousiaste             | 😊 Convaincue, militante            | 😊 Confiant, fier             | 😊 Ambassadrice, exigeante            |

### 5.1. Analyse des points de levier

**L'étape 2 cumule les frictions les plus fortes sur les 4 personas** :
...
- Lucia Martínez : frustrée par une inscription non accessible et une langue inadaptée → besoin d'un sélecteur de langue clavier + messages d'erreur lus par le lecteur d’écran.

> 🎯 **Investissement produit maximal** : améliorer l'étape 2 (Inscription / Évaluation) pour les 4 profils simultanément = effet de levier produit le plus fort.

### 5.2. Récapitulatif des investissements produit prioritaires
